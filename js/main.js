...
$scope.SVGicon43_click = function() {$scope.GotoPage( "landinghome" );};
$scope.PushButton233_click = function() {$scope.GotoPage( "PreparationKeys" );};
$scope.TextInput32_change = function() {localStorage.setItem("speedp2p",$App.speedp2p);};
});
...
$scope.TextInput33_change = function() {localStorage.setItem("speedp3p",$App.speedp3p);};
});
...
$scope.SVGicon45_click = function() {$scope.GotoPage( "landinghome" );};
$scope.TextInput34_change = function() {localStorage.setItem("speedp4p",$App.speedp4p);};
});
