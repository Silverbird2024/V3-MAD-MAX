...
$scope.landinghome_pageenter = function() {$App.VERSION = "v3.9998";
...
$scope.PushButton97_click = function() {$App.speeda = $App.speed01+"---"+$App.aka+"                                                "+$App.speed01b+"                                                 "+$App.speed01a+"                                                 "+$App.speed01c+"                                                 "+$App.speed01d+"                                                 "+$App.speed01e;
$scope.GotoPage( "Speedarchive" );};
$scope.PushButton191_click = function() {$scope.SizeObject("TextArea390","","125");
