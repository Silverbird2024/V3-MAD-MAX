...
$scope.PushButton1_click = function() {$App.VERSION = "v3.9859";
...
$scope.Headline748_click = function() {neoTalkSpeak($App.speed09b, "", $App.Read1, $App.Read2);};
$scope.Headline749_click = function() {neoTalkSpeak($App.speed20b, "", $App.Read1, $App.Read2);};
$scope.Headline750_click = function() {neoTalkSpeak($App.speed19b, "", $App.Read1, $App.Read2);};
$scope.Headline751_click = function() {neoTalkSpeak($App.speed18b, "", $App.Read1, $App.Read2);};
$scope.Headline752_click = function() {neoTalkSpeak($App.speed17b, "", $App.Read1, $App.Read2);};
$scope.Headline753_click = function() {neoTalkSpeak($App.speed16b, "", $App.Read1, $App.Read2);};
$scope.Headline754_click = function() {neoTalkSpeak($App.speed15b, "", $App.Read1, $App.Read2);};
$scope.Headline755_click = function() {neoTalkSpeak($App.speed14b, "", $App.Read1, $App.Read2);};
$scope.Headline756_click = function() {neoTalkSpeak($App.speed13b, "", $App.Read1, $App.Read2);};
$scope.Headline757_click = function() {neoTalkSpeak($App.speed08b, "", $App.Read1, $App.Read2);};
$scope.Headline758_click = function() {neoTalkSpeak($App.speed07b, "", $App.Read1, $App.Read2);};
$scope.Headline759_click = function() {neoTalkSpeak($App.speed10b, "", $App.Read1, $App.Read2);};
...
$scope.PushButton239_click = function() {$scope.GotoPage( "Speed21" );};
$scope.PushButton240_click = function() {$scope.GotoPage( "Speed22" );};
$scope.PushButton241_click = function() {$scope.GotoPage( "Speed19" );};
$scope.PushButton284_click = function() {$scope.GotoPage( "Speed20" );};
$scope.Headline760_click = function() {neoTalkSpeak($App.speed05b, "", $App.Read1, $App.Read2);};
$scope.Headline761_click = function() {neoTalkSpeak($App.speed06b, "", $App.Read1, $App.Read2);};
$scope.Headline762_click = function() {neoTalkSpeak($App.speed07b, "", $App.Read1, $App.Read2);};
$scope.Headline763_click = function() {neoTalkSpeak($App.speed08b, "", $App.Read1, $App.Read2);};
});
