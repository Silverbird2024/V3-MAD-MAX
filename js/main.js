...
localStorage.setItem("Resultspeed01a",$App.Resultspeed01a);
localStorage.setItem("Resultspeed01b",$App.Resultspeed01b);
localStorage.setItem("Resultspeed01c",$App.Resultspeed01c);
localStorage.setItem("Resultspeed01d",$App.Resultspeed01d);
localStorage.setItem("Resultspeed01e",$App.Resultspeed01e);
localStorage.setItem("Resultspeed01f",$App.Resultspeed01f);
localStorage.setItem("Resultspeed01g",$App.Resultspeed01g);
localStorage.setItem("Resultspeed01h",$App.Resultspeed01h);
localStorage.setItem("Resultspeed01i",$App.Resultspeed01i);
localStorage.setItem("Resultspeed01j",$App.Resultspeed01j);
localStorage.setItem("Resultspeed01k",$App.Resultspeed01k);
localStorage.setItem("Resultspeed01l",$App.Resultspeed01l);
localStorage.setItem("Resultspeed01m",$App.Resultspeed01m);};
...
$scope.PushButton233_click = function() {$App.read1 = "1.1";
$App.read2 = "1.1";};
});
...
$App.speed01a = localStorage.getItem("speed01a");
$App.speed01g = $App.speed01+"-"+$App.NAB.DateShort+"                      OVERVIEW:                      "+$App.speed01b+"                      STAGES:                      "+$App.speed01a+"                              MAIN:                                 "+$App.speed01c+"                              CONTACTS:                            "+$App.speed01d+"                                       NOTES:                                                   "+$App.speed01e+"                             End";
$App.speed01m = $App.speed01+"-"+$App.NAB.DateShort+"                      WHY WAS IT FROZEN?:                                  "+$App.speed01i+"                         WISH LIST TO UNFREEZE?:                             "+$App.speed01f+"                         INSTRUCTIONS TO UNFREEZE:                                             "+$App.speed01i+"   END";
$App.speed01n = $App.speed01g+"--"+$App.speed01m;
localStorage.setItem("HotlegL01a",$App.HotlegL01a);
localStorage.setItem("HotlegL01b",$App.HotlegL01b);
localStorage.setItem("HotlegL01c",$App.HotlegL01c);
localStorage.setItem("HotlegL01d",$App.HotlegL01f);
localStorage.setItem("HotlegL01e",$App.HotlegL01e);
...
$scope.TextArea109_change = function() {localStorage.setItem("speed01m",$App.speed01m);
$App.HotlegL01m = StrLen($App.speed01m+"");
$App.Resultspeed01m = $scope.Calculate("2500-"+$App.HotlegL01m,-1);};
$scope.PushButton254_click = function() {navigator.clipboard.writeText($App.speed01n);
$App.HotlegL01all = StrLen($App.speed01m+"");};
$scope.TextInput24_change = function() {localStorage.setItem("speed01n",$App.speed01n);};
$scope.PushButton269_click = function() {window.open($App.speed01n, "_blank");};
});
