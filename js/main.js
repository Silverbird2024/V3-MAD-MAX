...
$scope.TextArea128_change = function() {localStorage.setItem("speed01g",$App.speed01g);
$App.HotlegL01g = StrLen($App.speed01g+"");
$App.Resultspeed01g = $scope.Calculate("500-"+$App.HotlegL01g,-1);};
$scope.TextArea129_change = function() {localStorage.setItem("speed01e",$App.speed01e);
...
$scope.SizeObject("TextArea390","","1057");};
$scope.TextArea132_change = function() {localStorage.setItem("speed01i",$App.speed01i);
...
$scope.TextArea135_change = function() {localStorage.setItem("speed01d",$App.speed01d);
$App.HotlegL01d = StrLen($App.speed01d+"");
$App.Resultspeed01d = $scope.Calculate("600-"+$App.HotlegL01d,-1);};
$scope.TextArea136_change = function() {localStorage.setItem("speed01f",$App.speed01f);
